          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                DropDown2(
                  listItem: [
                    ModelLocal(id: "1", name: "Lớp 1"),
                    ModelLocal(id: "2", name: "Lớp 2"),
                    ModelLocal(id: "3", name: "Lớp 3"),
                    ModelLocal(id: "4", name: "Lớp 4"),
                    ModelLocal(id: "5", name: "Lớp 5"),
                    ModelLocal(id: "6", name: "Lớp 6"),
                    ModelLocal(id: "7", name: "Lớp 7"),
                    ModelLocal(id: "8", name: "Lớp 8"),
                    ModelLocal(id: "9", name: "Lớp 9"),
                    ModelLocal(id: "10", name: "Lớp 10"),
                    ModelLocal(id: "11", name: "Lớp 11"),
                    ModelLocal(id: "12", name: "Lớp 12"),
                  ],
                  hint: 'Chọn môn học',
                  onChanged: (val) {
                    req['lop'] = val.id;
